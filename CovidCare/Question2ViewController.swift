...
class Question2ViewController: UIViewController {
    ...
    private func setupButtons() {
        ...
        noButton.setBackgroundImage(UIColor.covidCareColor.asSolidBackgroundImage, for: .highlighted)

        yesButton.setTitleColor(.white, for: .highlighted)
        yesButton.setBackgroundImage(UIColor.covidCareColor.asSolidBackgroundImage, for: .highlighted)
    }
